...
describe('Test Screen "Calculator" Behavior', () => {
  ...
  it("Test If All Operators Button Adds Its Character To Calculator Value", () => {
    cy.get(
  ...
  it("Test If Clean Button Cleans Calculator Value", () => {
    cy.get(TEST_ID_HTML_ATTRIBUTE_CSS_SELECTOR(ONE_BUTTON_TEST_ID)).click({
      force: true,
    });
    cy.get(TEST_ID_HTML_ATTRIBUTE_CSS_SELECTOR(CLEAN_BUTTON_TEST_ID)).click({
  ...
  it("Test If Backspace Button Removes Last Character From Calculator Value", () => {
    cy.get(TEST_ID_HTML_ATTRIBUTE_CSS_SELECTOR(ONE_BUTTON_TEST_ID)).click({
      force: true,
    });
  ...
  it("Test If Evaluation Button Evaluates Calculator Value", () => {
    cy.get(TEST_ID_HTML_ATTRIBUTE_CSS_SELECTOR(ONE_BUTTON_TEST_ID)).click({
      force: true,
    });
    cy.get(TEST_ID_HTML_ATTRIBUTE_CSS_SELECTOR(ADDITION_BUTTON_TEST_ID)).click({
